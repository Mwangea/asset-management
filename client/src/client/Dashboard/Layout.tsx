...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    ...
    { icon: Box, label: 'Assets', path: '/user/assets' },
    { icon: QrCode, label: 'QR Scanner', path: '/user/scan' },
  ];
      ...
      >
        ...
        <div className="p-6">
          <div className="flex items-center space-x-4 mb-8 p-4 rounded-xl bg-gradient-to-r from-gray-50 to-gray-100 shadow-md">
            ...
            <div>
              <p className="font-semibold text-gray-800 text-lg">{user?.username || 'Employee001'}</p>
