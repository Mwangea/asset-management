...
const AdminOverview = () => {
  ...
  const assetDistributionWithPercentages =
    dashboardData?.distributions?.byType?.map((item) => ({
      ...item,
  ...
  const locationDistributionWithPercentages =
    dashboardData?.distributions?.byLocation?.map((item) => ({
      ...item,
      percentage: Math.round((item.count / (totalAssetCount || 1)) * 100) || 0,
    })) || [];
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        />
        <StatCard
          title="Reservable Assets"
          value={dashboardData?.stats.reservableAssets || 0}
          icon={Package}
          color="bg-green-600"
        />
      </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex justify-between mb-1">
                ...
                <span className="text-sm text-gray-500">
                  ...
                  {Math.round(
                    ((dashboardData?.stats?.assetsInUse || 0) /
                      (dashboardData?.stats?.totalAssets || 1)) *
                      100
                  ) || 0}
                  %)
                </span>
            ...
            <div>
              <div className="flex justify-between mb-1">
                ...
                <span className="text-sm text-gray-500">
                  ...
                  {Math.round(
                    ((dashboardData?.stats?.availableAssets || 0) /
                      (dashboardData?.stats?.totalAssets || 1)) *
                      100
                  ) || 0}
                  %)
            ...
            <div>
              <div className="flex justify-between mb-1">
                ...
                <span className="text-sm text-gray-500">
                  ...
                  {Math.round(
                    ((dashboardData?.stats?.assetsUnderMaintenance || 0) /
                      (dashboardData?.stats?.totalAssets || 1)) *
                      100
                  ) || 0}
                  %)
            ...
            <div>
              <div className="flex justify-between mb-1">
                ...
                <span className="text-sm text-gray-500">
                  {dashboardData?.stats?.reservableAssets || 0} assets (
                  {Math.round(
                    ((dashboardData?.stats?.reservableAssets || 0) /
                      (dashboardData?.stats?.totalAssets || 1)) *
                      100
                  ) || 0}
                  %)
